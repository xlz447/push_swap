...
P_SRC_NAME	=	push_swap.c queue.c stack.c print.c p_input.c index_group.c radix_sort.c sort_small.c dispatch.c ops_1.c ops_2.c ops_3.c
C_SRC_NAME	=	checker.c queue.c stack.c dispatch.c ops_1.c ops_2.c ops_3.c c_input.c print.c animation.c
